		...
		3: function(t, e, n) {
				...
				return e = t, (n = [{
					...
					value: function() {
						this.$popover = this.ui.popover({
							...
							callback: function(t) {
								t.find(".popover-content,.note-popover-content").prepend('<span><a  ></a>&nbsp;</span>')
							}
			...
			var xe = function() {
				...
				return e = t, (n = [{
					...
					value: function() {
						var t = this.options.dialogsInBody ? this.$body : this.options.container,
							e = ['<p class="text-center">', '<a href="http://summernote.org/"  >Summernote 0.8.18</a> Â· ', '<a href="https://github.com/summernote/summernote"  >Project</a> Â· ', '<a href="https://github.com/summernote/summernote/issues"  >Issues</a>', "</p>"].join("");
						this.$dialog = this.ui.dialog({
